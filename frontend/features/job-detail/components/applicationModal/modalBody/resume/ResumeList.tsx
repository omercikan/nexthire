...
import { AppDispatch, RootState, store } from "@/shared/redux/store";
import useSelectResume from "@/shared/hooks/useSelectResume";
import { useFetchResumeQuery } from "@/shared/redux/services/resumeApi";
import { setPlaceholderUploadData, setUploadedFileNames } from "@/shared/redux/slices/applicationModal/modalData";
